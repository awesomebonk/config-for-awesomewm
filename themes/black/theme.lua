...
local theme                                   				= {}
theme.dir                                       				= os.getenv("HOME") .. "/.config/awesome/themes/black"
theme.wallpaper                          				= theme.dir .. "/triangle-dark-black-4k-31.jpg"
theme.font                                            		= "Input Mono Compresses 11"
theme.taglist_font                       				= "Iosevka Slab Medium 14"
theme.fg_normal                        				= "#FFFFFF" --font color in taglist  
...
theme.tasklist_bg_focus            			    = "#7F7F7F"
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            pl(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, "#565454"),
            pl(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, "#DC43D6"),
            pl(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, "#565454"),
            pl(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, "#DC43D6"),
        },
    }
end

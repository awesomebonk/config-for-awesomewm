...
theme.wallpaper                          				= theme.dir .. "/1608129591715.png"
...
theme.bg_focus                           				= "#FF4929"
theme.bg_urgent                           				= "#3F3F3F"
theme.taglist_fg_focus               				= "#000000" 
theme.tasklist_bg_focus            			    = "#FF0B23"
theme.tasklist_fg_focus            				= "#000000"
theme.border_width                       	       	= dpi(2)
theme.border_normal                         	    = "#F30100"
theme.border_focus                               	= "#A52A2A"
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            pl(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, "#FF0000"),
            pl(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, "#000000"),
            pl(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, "#FF0000"),
            pl(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, "#000000"),
        },
    }
end

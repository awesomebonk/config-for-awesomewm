...
local theme                                   				= {}
theme.dir                                       				= os.getenv("HOME") .. "/.config/awesome/themes/pink"
theme.wallpaper                          				= theme.dir .. "/1595528166815.png"
theme.font                                            		= "Input Mono Compresses 11"
theme.taglist_font                       				= "Iosevka Slab Medium 14"
theme.fg_normal                        				= "#000000" 
theme.fg_focus                            				= "#FF0000" 
theme.fg_urgent                          	 			= "#D8A77A"
theme.bg_normal                        				= "#F40098" 
...
theme.border_normal                         	    = "#FF45B5"
theme.border_focus                               	= "#FF01C6"
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            pl(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, "#F81C1D"),
            pl(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, "#DDCEDA"),
            pl(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, "#F81C1D"),
            pl(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, "#DDCEDA"),
        },
    }
end

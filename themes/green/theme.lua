...
theme.wallpaper                          				= theme.dir .. "/1595186827380.jpg"
theme.font                                            		= "Input Mono Compresses 11"
theme.taglist_font                       				= "Iosevka Slab Medium 14"
theme.fg_normal                        				= "#FFFFFF" 
theme.fg_focus                            				= "#000000" 
theme.fg_urgent                          	 			= "#1A1A1A"
theme.bg_normal                        				= "#90EE90" 
theme.bg_focus                           				= "#4CFF00"
theme.bg_urgent                           				= "#3F3F3F"
theme.taglist_fg_focus               				= "#000000" 
theme.tasklist_bg_focus            			    = "#70D647"
theme.tasklist_fg_focus            				= "#000000"
theme.border_width                       	       	= dpi(2)
theme.border_normal                         	    = "#02CE53"
theme.border_focus                               	= "#08732B"
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            pl(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, "#629DD6"),
            pl(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, "#46E7E0"),
            pl(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, "#629DD6"),
            pl(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, "#46E7E0"),
        },
    }
end

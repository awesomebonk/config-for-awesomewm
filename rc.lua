...
globalkeys = my_table.join(
    ...
    awful.key({ modkey1 }, "L", function () awful.spawn{ "mate-screensaver" } end),
    awful.key({ modkey  }, "F4", function () awful.util.spawn( "gnome-boxes" ) end),
    ...
    -- Screenshots
    awful.key({ }, "Print", function () awful.spawn.with_shell("maim -s -u ~/Pictures/$(date +%s).png") end,
...
awful.rules.rules = {
    ...
    { rule = { class = "mate-control-manager" },
